...
/**
 * Simple Working Kaspresso Test Suite
 * Uses basic Kaspresso configuration with Page Objects
 * Implements core test scenarios without complex dependencies
 */
...
class SimpleKaspressoTest : TestCase() {
    ...
    fun setup() {
        ...
        ScreenshotUtils.captureScreenshot("setup", "initial_state", 0)
    }

    @After
    fun teardown() {
        ScreenshotUtils.captureScreenshot("teardown", "final_state", 99)
    }
 ...
 */
private val TestCase.device get() = androidx.test.uiautomator.UiDevice.getInstance(
