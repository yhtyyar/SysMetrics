...
class NetworkDataSource constructor(
    ...
    // Guards the baseline read-modify-write below — this instance can be shared (via Hilt
    // @Singleton) between the UI's continuous Flow and the periodic background Worker, which
    // otherwise race on the same lastRxBytes/lastTxBytes/lastTimestamp/isInitialized fields.
